...
namespace Wisielec
{
    public partial class Form1 : Form
    {
        ...
        {
            string[] slowa = { "krokusy", "liliput", "kacper", "selerek", "marchew", "krakers", "klakier", "telefon", "igliwe","intruzi","depozyt","domofon" };
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            if (ile_pudel < 5)
            {
                ...
                if (czy_trafiony == false)
                {
                    ...
                    if (ile_pudel == 5) { pictureBox1.Image = Wisielec.Properties.Resources._5png; }
